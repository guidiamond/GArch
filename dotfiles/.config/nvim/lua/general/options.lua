...
local options = {
	...
	opt = {
		...
		-- Fold (commented since we are setting this at treesitter.lua)
		-- foldenable = false,
		foldlevelstart = 10, -- Number of folding levels that are opened by default (sets the minimum fold level that a fold needs to be in order to start opened)
		foldnestmax = 10, -- Sets the maximum level of folds that can be nested (default 10)
		-- foldmethod = "syntax",

		-- UI
		signcolumn = "yes", -- Always show the sign column so diagnostic icons are visible
