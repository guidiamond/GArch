...
class VenvManager:
    def __init__(self):
        ...
        self.venv_path = path.abspath("/home/damndiamond/.virtualenv")
        self.zshrc_file = path.abspath("/home/damndiamond/.config/zsh/zshrc")
        self.select_menu()
        print("============================")
        self.run_option()
        # venv_path = path.abspath("/home/damndiamond/.virtualenv")
        # zshrc_file = path.abspath("/home/damndiamond/.config/zsh/zshrc")
